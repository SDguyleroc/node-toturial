 ...
 * each product has an id, name, image, price, description
 * 
 * products is an array of objects
 * 
 * We also have a list of people
 * each person has an id, name
 * 
...
const products = [
  ...
  // we are exporting an object containing products and people
